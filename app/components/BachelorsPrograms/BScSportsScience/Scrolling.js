...
const journeyTitle = "Your Sports Science Journey at AYRA"

const milestones = [
  { label: "Day 0", text: "Regular Entry to BSc (Sports Science) Program" },
  {
    label: "Year 1",
    text: "Exit with a Certificate in Sports Science with 40 Credits.",
  },
  {
    label: "Year 2",
    text: "Exit with a Diploma in Sports Science with 80 Credits.",
  },
  {
    label: "Year 3",
    text: "Exit with BSc (Sports Science) Degree with 120+ Credits.",
  },
  {
    label: "Year 4",
    text: "Exit with BSc Honors in Sports Science Degree with 160+ Credits.",
  },
]
        ...
        <div className="relative z-10 flex flex-col md:flex-row-reverse w-full container mx-auto px-4 md:px-0 gap-6 md:gap-4 h-auto md:h-[100vh] py-8 sm:py-10 md:py-0">
          ...
          <div className="w-full md:w-[70%] flex flex-col justify-center md:pr-4 relative text-left">
            <div className="h-auto max-w-3xl mx-0 md:max-w-none">
              <h2 className="text-[26px] sm:text-[34px] md:text-[56px] lg:text-[72px] xl:text-[78px] uppercase text-[#FFA300] mb-4 sm:mb-6 leading-[0.95] font-schabo">
                {journeyTitle}
              </h2>
