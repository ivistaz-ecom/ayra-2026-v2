      ...
      <div className="container mx-auto px-4 md:px-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-0">
          <div className="order-2 md:order-1 py-6 md:py-12 md:pr-10 lg:pr-14 text-left md:border-r md:border-dashed md:border-[#8E8E8E] space-y-2 md:space-y-4">
            ...
            <p className="font-tthoves-light text-black text-sm sm:text-base leading-relaxed  max-w-[520px] mx-0">
              Students are given the space to understand how data connects to
              real decisions. Through case studies, projects, and practical
              exposure, learning moves beyond tools into interpretation and
              application.
            </p>
            <p className="font-tthoves-light text-black text-sm sm:text-base leading-relaxed  max-w-[520px] mx-0">
              You begin with foundational concepts and gradually build
              analytical thinking, allowing you to understand where your
              strengths lie within the business and analytics space.
            </p>
          </div>

          <div className="order-1 md:order-2 py-4 md:py-12 md:pl-10 lg:pl-14 flex items-center justify-center md:justify-start">
            <Image
              src="/bba-programs/business-analytics/bba-different.png"
              width={820}
              height={330}
