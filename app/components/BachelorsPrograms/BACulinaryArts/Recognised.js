...
const highlights = [
  ...
  "Integrates culinary training with hospitality and service management",
]
      ...
      <div className="container mx-auto px-4 md:px-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
          <div className="text-left">
            <h2 className="font-schabo text-[#FF5EBB] text-[40px] sm:text-[48px] md:text-[72px] lg:text-[96px] leading-[0.95] md:leading-[1em] uppercase">
              Recognised.
              <br />
              Structured.
              <br />
