        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-0">
          <div className="order-2 md:order-1 py-6 md:py-12 md:pr-10 lg:pr-14 text-left md:border-r md:border-dashed md:border-[#8E8E8E]">
            <p className="font-tthoves-light text-black text-sm sm:text-base leading-relaxed max-w-[520px] mx-0">
              At AYRA, culinary learning is built around practice and
              experience.
            </p>

            <p className="font-tthoves-light text-black text-sm sm:text-base leading-relaxed mt-6 md:mt-8 max-w-[520px] mx-0">
              Students do not just learn techniques - they work through them,
              observe how kitchens function, and gradually understand how
              preparation, presentation, and service come together.
            </p>

            <p className="font-tthoves-light text-black text-sm sm:text-base leading-relaxed mt-6 md:mt-8 max-w-[520px] mx-0">
              With exposure to different areas of culinary practice, students
              are able to develop both skill and clarity in how they want to
              approach the field, rather than being pushed into one direction
              too early.
            </p>
          </div>
          ...
          <div className="order-1 md:order-2 py-4 md:py-12 md:pl-10 lg:pl-14 flex items-center justify-center md:justify-start">
            <Image
              src="/school-of-engg-tech/ba-culinary-arts/diffferent.png"
              width={820}
              height={330}
