...
export default function PaperFoldingScroll() {
  ...
  return (
    <div ref={trackRef} style={{ height: trackHeight }} className="relative">
      ...
      >
        <div className="relative z-10 flex flex-col md:flex-row-reverse w-full container mx-auto px-4 md:px-0 gap-4 md:gap-3 h-auto md:h-[100vh] py-3 sm:py-4 md:py-0">
