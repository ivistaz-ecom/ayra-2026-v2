        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center">
          <div className="text-left">
            ...
            <p className="mt-6 text-black font-tthoves-light text-sm md:text-base leading-relaxed max-w-[520px] mx-0">
              At AYRA, management education connects theory, application, and
              decision-making.
            </p>
            <p className="mt-6 text-black font-tthoves-light text-sm md:text-base leading-relaxed max-w-[520px] mx-0">
              Students develop an understanding of how different business
              functions work together, while also building analytical,
