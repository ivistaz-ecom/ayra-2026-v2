          ...
          <div className="absolute inset-0 flex md:hidden items-end justify-center px-5 pb-10">
            <div className="w-full text-left">
              ...
              <p className="mt-6 font-tthoves-light text-white text-[15px] leading-snug">
                Admissions are based on the University's eligibility guidelines
                and may consider performance in recognised entrance tests or
                qualifying assessments, where applicable
              </p>
            ...
            <div className="w-full md:w-[50%] px-3 sm:px-4 md:px-6 py-4 sm:py-5 md:pt-[160px] md:pb-6 text-white bg-[#0a2866]/88 md:bg-transparent backdrop-blur-[1px] md:backdrop-blur-none rounded-none md:rounded-none">
              ...
              <ul className="mt-1 space-y-1.5 font-tthoves-light text-[11px] sm:text-[12px] md:text-[12px] leading-relaxed text-left">
                <li className="flex items-start gap-2">
                  ...
                  />
                  <span>
                  The candidate must hold a Bachelor’s degree in any discipline
                ...
                <li className="flex items-start gap-2">
                  ...
                  />
                  <span>
                  Candidates must have obtained 50% or equivalent aggregate
                  marks, or as prescribed by the university as per applicable
                  regulations.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  />
                  <span>
                  In case of SC/ST/OBC/Category I candidates, relaxation in
                  eligibility criteria may be considered as per applicable
                  regulations.
                  </span>
                </li>
                <li className="flex items-start gap-2">
              ...
              <p className="mt-1 font-tthoves-light text-[11px] sm:text-[12px] md:text-[12px] leading-relaxed text-left">
                Candidates may be required to participate in an interaction or
                interview to assess managerial aptitude and communication
                skills.
              </p>
              <p className="mt-1 font-tthoves-light text-[11px] sm:text-[12px] md:text-[12px] leading-relaxed text-left">
                Strong analytical ability, leadership potential, and
                communication skills are considered desirable.
              </p>
            </div>
          </div>
        </div>
