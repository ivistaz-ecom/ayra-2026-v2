    ...
    <section className="w-full bg-white py-8 md:py-10">
      <div className="container mx-auto px-4 md:px-0">
        <div className="relative">
          ...
          <Image
            src="/school-of-engg-tech/btech/starting-your-journey.webp"
            width={1600}
            height={900}
          ...
          />
          <Image
            src="/school-of-engg-tech/btech/starting-your-journey-mobile.webp"
            width={900}
            height={520}
            alt="Starting your journey at AYRA"
          ...
          <div className="absolute inset-0 hidden md:flex items-end sm:items-start justify-center md:justify-end pt-0 sm:pt-8 md:pt-24 px-0 md:px-8 pb-0 md:pb-0">
            <div className="w-full md:w-[50%] px-3 sm:px-4 md:px-6 py-4 sm:py-5 md:pt-[160px] md:pb-6 text-white bg-[#0a2866]/88 md:bg-transparent backdrop-blur-[1px] md:backdrop-blur-none rounded-none md:rounded-none">
              <p className="mt-0 md:mt-1 font-tthoves-light text-[18px] text-left">
                Admissions and eligibility
                <br />
                Duration: 4 years
              </p>

              <h3 className="mt-3 font-tthoves-bold text-[12px] sm:text-xs md:text-[18px] text-left">
                Eligibility Criteria:
              </h3>
              <ul className="mt-1 space-y-1.5 font-tthoves-light text-[11px] sm:text-[12px] md:text-[14px] leading-relaxed text-left">
