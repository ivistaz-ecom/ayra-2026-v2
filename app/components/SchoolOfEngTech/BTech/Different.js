      ...
      <div className="container mx-auto px-4 md:px-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-0">
          ...
          At AYRA, engineering is not about choosing a path too early.
            ...
            <p className="font-tthoves-light text-black text-[18px] leading-relaxed mt-6 md:mt-4 max-w-[520px] mx-0">
          ...
          <div className="order-1 md:order-2 py-4 md:py-12 md:pl-10 lg:pl-14 flex items-center justify-center md:justify-start">
            <Image
              src="/school-of-engg-tech/btech/What-makes-this-program-different.webp"
              width={820}
              height={330}
