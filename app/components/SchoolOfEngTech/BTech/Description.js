      ...
      <div className="container mx-auto flex flex-col gap-6 md:gap-10 px-4 md:px-0">
        <div className="flex flex-col items-center">
          <div className="container mx-auto lg:border-l lg:border-r border-dashed border-[#8E8E8E] flex items-center justify-center flex-col text-center">
            <p className="text-center w-full max-w-xl md:max-w-4xl  pt-4 pb-1 font-tthoves-light text-[18px] leading-relaxed text-black">
              Your engineering journey at AYRA begins as an open canvas.
            </p>

            <p className="text-center w-full max-w-xl md:max-w-4xl  font-tthoves-light text-[18px] leading-relaxed text-black">
              You start by understanding how technology works, but more
              importantly, you learn how to think with it.
            </p>

            <p className="text-center w-full max-w-xl md:max-w-5xl  font-tthoves-light text-[18px] leading-relaxed text-black">
            ...
            <p className="text-center w-full max-w-xl md:max-w-5xl  pb-4 pt-1 font-tthoves-light text-[18px] leading-relaxed text-black">
