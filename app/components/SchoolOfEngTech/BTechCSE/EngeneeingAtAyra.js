...
const yearJourney = [
  {
    title: "Year 1 - Foundations of Computing",
    description:
      "Mathematics, programming fundamentals, computational thinking, and engineering sciences.",
  },
  {
    title: "Year 2 - Core Computer Science",
    description:
      "Data structures, algorithms, database systems, operating systems, and computer networks.",
  },
  {
    title: "Year 3 - Advanced Computing Technologies",
    description:
      "Cloud computing, cybersecurity, distributed systems, software engineering, and elective specializations.",
  },
  {
    title: "Year 4 - Industry Integration",
    description:
      "Industry internships, advanced electives, and a capstone project addressing real-world computing challenges.",
  },
]
    ...
    <section className="w-full bg-[#744AC6] py-6 md:py-7">
      <div className="container mx-auto px-4 md:px-0">
        <h2 className="text-[#FFFFFF] text-lg sm:text-xl md:text-2xl leading-[1.2] max-w-[680px] text-left mx-0">
          Computer Science at AYRA unfolds as a four-year journey of
          exploration, mastery, and application.
        </h2>
