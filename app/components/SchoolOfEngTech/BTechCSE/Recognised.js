      ...
      <div className="container mx-auto px-4 md:px-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
          <div className="text-left">
            <h2 className="font-schabo text-[#744AC4] text-[40px] sm:text-[48px] md:text-[72px] lg:text-[96px] leading-[0.95] md:leading-[1em] uppercase">
              Recognised.
              <br />
              Structured.
              <br />
            ...
            <ul className="mt-6 space-y-4 text-black font-tthoves-light text-[16px] max-w-xl mx-0 md:max-w-none">
              {highlights.map((item) => (
          ...
          <div className="py-[5px]">
            <Image
              ...
              width={886}
              height={746}
              alt="B.Tech Computer Science programme recognition and accreditation"
