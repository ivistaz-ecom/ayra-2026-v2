...
const milestones = [
  {
    label: "Day 0",
    text: "Regular Entry to B.Tech (Computer Science) Program",
  },
  {
    label: "Year 1",
  ...
  {
    label: "Year 2",
    text: "Exit with a Diploma in Computer Science with 80 Credits.",
  },
  {
    label: "Year 3",
    text: "Exit with BSc Computer Science with 120+ Credits.",
  },
  {
    label: "Year 4",
    text: "Exit with B.Tech Computer Science Degree with 160+ Credits.",
  },
]
