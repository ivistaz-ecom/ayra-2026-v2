...
const SemesterColumn = ({ title, items, showItems }) => {
  return (
    <div className="py-3 px-1.5 sm:px-2 md:py-6 md:px-0 text-left flex flex-col items-start md:items-center md:text-center">
      <div className="font-tthoves-bold text-white text-[13px] sm:text-[18px] md:text-[18px] lg:text-[22px] leading-tight w-full md:w-auto text-left md:text-center">
        {title}
      </div>
    ...
    >
      ...
      <div className="md:hidden min-h-[4.5rem]">
        <div className="flex flex-col items-start justify-start text-left py-3 px-1 sm:px-2">
          ...
          {isOpen ? (
            <>
              <div className="mt-2 font-schabo uppercase text-white text-[18px] sm:text-[17px] leading-[1]">
                {phaseLabel}
              </div>
...
const Accordion = () => {
  ...
  return (
    <section className="w-full bg-[#744AC6] py-8 sm:py-10 md:py-16">
