...
const points = [
  "Industry certifications in AI and machine learning technologies",
  "Participation in AI hackathons and innovation challenges",
  "Workshops and guest lectures by AI researchers and industry professionals",
  "Exposure to multidisciplinary applications of AI across sectors",
  "Opportunities to engage in research and technology innovation",
  "Development of leadership, communication, and project management skills",
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
          <div className="text-left order-2 md:order-1">
            ...
            <p className="mt-4 font-tthoves-light text-black text-sm md:text-base leading-snug max-w-xl mx-0">
              Students strengthen their expertise through additional
